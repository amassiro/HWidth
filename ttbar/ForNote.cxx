...
/* 
 ...
 std::string nameFileRate = "test/HWidth/ttbar/result-value.txt";
 std::string nameFileSyst = "test/HWidth/ttbar/result-syst.txt";
 std::string nameFileSyst_Method = "test/HWidth/ttbar/result-syst-method.txt";
 std::string nameFileSyst_Stat = "test/HWidth/ttbar/result-syst-stat.txt";
 std::string nameFileSyst_CR_Stat = "test/HWidth/ttbar/result-syst-CR-stat.txt";
 std::string nameFileSyst_MCSub = Form("test/HWidth/ttbar/result-syst-MCSub.txt");

...
//  std::string NameFolders[] = {"init","sig","bkg"};
 ...
 std::string NameSamples[] =    {"model","WW",           "WJet","Top","VV","DYTT"      ,"ggH", "qqH","ggH_sbi","ggH_s","ggH_b","qqH_sbi","qqH_s","qqH_b"};
//  std::string NameSamples[] = {"model","WW","Vg","Vgs","WJet","Top","VV","DYTT","VVV","ggH", "qqH","ggH_sbi","ggH_s","ggH_b","qqH_sbi","qqH_s","qqH_b"};
